...
$(document).ready(function(){
    ...
    apiCall("https://restcountries.com/v3.1/all?fields=name,cca3,flags,capital", displayPaises, 12)
})
...
function displayPaises(dataPaises){    
    $.each(dataPaises, function(index,dataPais){
        ...
        let nomeCommon = dataPais.name['common'];
        let capital = dataPais.capital[0]
        ...
        `      
                    <div class="card">
                        <img class="card-img" src="${fotoPais}" alt="Foto do Pais">
                        <div class="card-body">
                            <div class="row">  
                                <div class="col-9">
                                    <h5 class="card-title">${nomeCommon}</h5>
                                </div>
                                <div class="col-3">
